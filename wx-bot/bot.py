...
class TulingWXBot(WXBot):
    def __init__(self):
        ...
        self.tuling_key = "e64ad48100081ab77b668aa3105fe552"
    ...
    def get_api(self, uid, msg):
        if self.tuling_key:
            url = "http://192.168.31.149:8003/weixin_robot_api.php"
            user_id = uid.replace('@', '')
        ...
        if msg['msg_type_id'] == 1 and msg['content']['type'] == 0:  # reply to self
            ...
            if 'detail' in msg['content']:
                ...
                if msg['content']['type'] == 0:  # text message                
                    # reply += self.get_api(msg['content']['user']['id'], msg['content']['desc'])
