...
def on_open(self):
    #subscribe okcoin.com spot ticker ### usd=>cny
    self.send("{'event':'addChannel','channel':'ok_sub_spotcny_btc_ticker','binary':'true'}") 
    #subscribe okcoin.com future this_week ticker 
    # self.send("{'event':'addChannel','channel':'ok_sub_futurecny_btc_ticker_this_week','binary':'true'}")
...
if __name__ == "__main__":
    ...
    api_key='ca0089ef-2276-4927-a72b-12db4c8acf56'
    secret_key = "F0615270DAB90AE673E277502223B8C5"
